/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: ab06af0fc23ef76271888e938c93ed59)
// Runtime types generated with workerd@1.20260124.0 2026-01-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		GOOGLE_AI_API_KEY: "AIzaSyAkSISZ07Rb6ylrso2vN5QwPtds5AHINqs";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_AI_API_KEY" | "FRONTEND_APP_URL" | "LANGFUSE_SECRET_KEY" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_BASE_URL">> {}
}
